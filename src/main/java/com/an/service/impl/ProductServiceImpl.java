...
public class ProductServiceImpl implements ProductService {
	...
	public List<Product> findProductDataByPageAndCount(int i, int page, String searchStr) {
		...
		return productMapper.findProductDataByPageAndCount(i, (page-1)*i, searchStr);
	}
	...
	@Override
	public List<Product> findByDictionary(String ddName) {
		// TODO Auto-generated method stub
		return productMapper.findByDictionary(ddName);
	}
