<%@page import="com.an.entity.User"%>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li><i class="fa fa-laptop"></i>用户编辑</li>
			</ol>
		</div>
	</div>
	<div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="form-control" id="userName" name="userName"
								type="text" readonly="readonly" value="${user.userName }" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="form-control" id="userTel" name="userTel"
								type="text" readonly="readonly" value="${user.userTel }" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="form-control" id="userIntroduce"
								name="userIntroduce" type="text" value="${user.userIntroduce }" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">Role</label>
						<div class="col-sm-3">
						<input type="hidden" id="user_role" name="user_role" value="${user.userRole }"/>
							<select class="form-control m-bot15" id="userRole"
								name="userRole">
								<option id="admin" name="userRole" value="1">管理员</option>
								<option id="member" name="userRole" value="2">普通会员</option>
							</select>
						</div>
					</div>
				</form>
